      ...
      <div className="container">
        <div className="footer__container">
          <div className="footer__logo-wrapper">
            <Link className="footer__logo logo" to={RouteName.ProductList}>
          ...
          <section className="footer__nav-section footer__nav-section--about">
            ...
            <p className="footer__nav-text footer__nav-text--about">Все инструменты проверены, отстроены
              и&nbsp;доведены до&nbsp;идеала!</p>
          </section>
